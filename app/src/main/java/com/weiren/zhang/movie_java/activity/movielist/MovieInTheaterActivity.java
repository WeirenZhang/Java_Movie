...
import com.weiren.zhang.movie_java.viewmodel.movielist.MovieInTheaterViewModel;

import java.util.List;

@Route(path = RouterActivityPath.MovieList.PATH_InTheater_HOME)
public class MovieInTheaterActivity extends BaseBindVMActivity<RecyclerviewBinding, MovieInTheaterViewModel>
