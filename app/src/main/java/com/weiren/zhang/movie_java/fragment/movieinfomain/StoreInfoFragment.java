...
import com.weiren.zhang.movie_java.adapter.movieinfomain.StoreInfoAdapter;
...
import com.weiren.zhang.movie_java.viewmodel.movieinfomain.StoreInfoViewModel;

@Route(path = RouterActivityPath.MovieInfoMain.PATH_StoreInfo_HOME)
public class StoreInfoFragment extends BaseBindVMFragment<RecyclerviewBinding, StoreInfoViewModel>
    ...
    protected void initView() {
        ...
        storeInfoAdapter = new StoreInfoAdapter();
        mViewDataBinding.includeRefresh.recy.setAdapter(storeInfoAdapter);
    ...
    protected void initData() {
        ...
        mViewModel.mListMutable.observe(this, datasBeans -> {
            ...
            if (datasBeans != null && datasBeans.size() > 0) {
                storeInfoAdapter.setList(datasBeans);
            } else {
                showEmpty();
            }
            isLoading = false;
    ...
    private void loadData() {
        mViewModel.getStoreInfoList(movieListModel.getId());
    }
