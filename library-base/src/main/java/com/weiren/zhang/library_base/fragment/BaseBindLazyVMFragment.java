 ...
 * 需要懒加载Fragment继承此类
 */
public abstract class BaseBindLazyVMFragment<V extends ViewDataBinding, VM extends BaseViewModel>
    ...
    private void dispatchParentVisibleState() {
        ...
        for (Fragment child : fragments) {
            if (child instanceof BaseBindLazyVMFragment && ((BaseBindLazyVMFragment) child).isVisibleToUser) {
                ((BaseBindLazyVMFragment) child).tryLoadData();
            }
        }
    }
